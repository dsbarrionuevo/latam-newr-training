...
export YOUR_NAME='Diego Barrionuevo'
export YOUR_COMPANY_NAME='Thirdlove'
export NEW_RELIC_LICENSE_KEY='cb382f0547421d4b1a7d4baf8361d39f982ba93a'
...
export GITHUB_USER='dsbarrionuevo'
export GITHUB_USER_NAME='Diego Barrionuevo'
export GITHUB_USER_EMAIL='dbarrionuevo@thirdlove.com'
